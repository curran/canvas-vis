...
(function() {
  var Attribute, Point, Rect, Relation, Scale, Viewport, app, ctx, e, express, inNode, match, port, t, type,
  ...
  Scale = (function() {
    ...
    Scale.prototype.normalize = function(key) {
      return (this.attribute.map[key] - this.min) / (this.max - this.min);
    };
  ...
  if (inNode) {
    ...
    $.get('iris.csv', function(data) {
      var dest, inPt, key, margin, maxRadius, minRadius, outPt, points, r, rScale, radius, rect, relation, src, table, unit, viewport, xScale, yScale, _i, _len, _ref, _results;
